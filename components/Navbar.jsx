    ...
    <>
        <nav className="relative w-full flex items-center bg-gray-200 h-12">
            <div className="flex items-center justify-between mx-3 w-full md:w-auto">
                <div 
                    className={ router.pathname === '/' ? "text-gray-400 px-5" : "text-gray-700 hover:text-gray-400 px-5" }                    
                >
            ...
            <div className="hidden md:flex items-center justify-center px-3 mx-5">
                <div 
                    className={ router.pathname === '/projects' ? "text-gray-400 px-5" : "text-gray-700 hover:text-gray-400 px-5" }                    
                >
                    <Link href="/projects">Projects</Link>
                </div>
                <div 
                    className={ router.pathname === '/cv' ? "text-gray-400 px-5" : "text-gray-700 hover:text-gray-400 px-5" }                    
                >
                    <Link href="/cv">Curriculum</Link>
                </div>
                <div 
                    className={ router.pathname === '/blog' ? "text-gray-400 px-5" : "text-gray-700 hover:text-gray-400 px-5" }                    
                >
                    ...
                    <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                        ...
                        <div role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
                            <div className="px-2 pt-2 pb-3 space-y-1" role="none">
                                <div className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" role="menuitem">
                                    <Link href="/projects">Projects</Link>
                                </div>
                                <div className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" role="menuitem">
                                    <Link href="/cv">Curriculum</Link>
